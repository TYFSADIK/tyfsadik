...
<p>
  ...
  <img src="https://img.shields.io/badge/Certifications-20%2B_Active-bb9af7?style=flat&labelColor=1a1b26" alt="certifications" />
...
mailto:taki@tyfsadik.org
https://www.linkedin.com/in/md-taki-yasir-faraji-sadik-63a026278/
https://github.com/TYFSADIK
</div>
<img src="https://capsule-render.vercel.app/api?type=rect&color=0:1a1b26,50:7aa2f7,100:1a1b26&height=3" alt="divider" />
About Me
I am a cybersecurity analyst focused on the detection, triage, and response side of the SOC: reading alerts, tracing root cause, and closing the loop before a small anomaly becomes an incident. I split my time between hardening Azure and AWS cloud infrastructure professionally and running a production-grade homelab that hosts everything from a self-trained LLM to a zero-public-ingress private cloud. Everything in it is built, broken, and rebuilt by hand; that hands-on loop is where most of what I know about defending infrastructure actually came from.
I also design and deploy responsive, accessibility-first business websites for local clients, from initial brief through deployment on GitHub Pages.
<div align="center">
<p>
...
Currently Building
    ...
    Hardening the TYF-AI inference platform with automated model validation pipelines and enhanced sandboxing policies
    Mapping additional MITRE ATT&CK techniques into the automated SOC pipeline for broader detection coverage
    Contributing to open-source security tools and documenting homelab architectures at tyfsadik.org
    Preparing for CompTIA Security+ and Cisco Cyber Defense Analyst certifications
...
Aug 2025 - Present | Toronto, ON
    ...
    Lead end-to-end incident lifecycle: detection, triage, prioritization, escalation, resolution, and post-incident review at critical national infrastructure.
...
Jun 2024 - Jul 2025 | Contract Part-time
    ...
    Performed daily maintenance: backup verification, system updates, patch application, and performance monitoring.

Surveillance Operator / Help Desk @ Elite Force / Rogers Center
...
<img src="https://capsule-render.vercel.app/api?type=rect&color=0:1a1b26,50:7aa2f7,100:1a1b26&height=3" alt="divider" />
Flagship Infrastructure & Security Projects
<table>
<tr>
<td valign="top" width="50%">
...
PyTorch Distributed Training GGUF llama.cpp Next.js
</td>
</tr>
<tr>
<td valign="top" width="50%">
...
Wazuh TheHive Cortex MISP MITRE ATT&CK
</td>
<td valign="top" width="50%">
Active Directory Threat Hunting Lab
Instrumented AD forest with Sysmon and Splunk; hunted Kerberoasting, Pass-the-Hash, and Golden Ticket attacks. Deployed honeypot SPN account for high-fidelity early warning. Detected PtH within 2 minutes; mapped 15+ lateral-movement paths to Domain Admin.
BloodHound Sysmon Splunk Kerberos Threat Hunting
</td>
</tr>
</table>
<details>
...
<td valign="top" width="50%">
GTA High Glass
Multi-page website for a glass and glazing contractor in the Greater Toronto Area. Features a services showcase, filterable project gallery with CSS Grid auto-fill and aspect-ratio locking, and a quote request form. Mobile-first responsive layout with WebP image optimization and Safari-specific hero fixes.
HTML5 CSS3 CSS Grid Flexbox Responsive Business Website
Hakimi Fruits
Online presence for a local fruit and produce business with seasonal highlights, filterable product listings by category (citrus, berries, tropical), and an order inquiry form. JavaScript category filtering via data-* attributes; CSS Grid auto-fill for responsive product cards.
HTML5 CSS3 JavaScript Responsive E-commerce Business Website
HomeBound Aisha
Multi-page responsive website for a home-based cleaning and domestic service provider. Four pages: landing, services with pricing tiers, about/trust signals, and a validated enquiry form. Earned 4 GitHub stars. BEM naming conventions, ARIA labels, and focus management for accessible navigation.
HTML5 CSS3 JavaScript Responsive Client Project GitHub Pages
</td>
<td valign="top" width="50%">
Pharmacy Website
Accessibility-first medical/pharmacy website built to WCAG AA contrast standards (4.5:1 minimum). Features live product search with aria-live announcements, schema.org structured data for SEO, keyboard-navigable elements, and a responsive Google Maps embed.
HTML5 CSS3 JavaScript Accessibility Healthcare WCAG AA
GateArch
Student portal with course management system built in PHP, MySQL, and JavaScript. Full CRUD operations for courses, students, and enrollment tracking.
PHP MySQL JavaScript HTML/CSS
TaxGlobe
Multi-jurisdiction tax calculator with real-time computation and clean responsive UI. Handles federal and provincial tax brackets with dynamic output rendering.
...
AWS Cloud Practitioner	Amazon Web Services	Active
AWS Academy - Cloud Security	AWS	Nov 2025
CompTIA A+	CompTIA	Active
CCNA Fundamentals	Cisco Networking Academy	Active
OPSWAT CIP	OPSWAT Academy	Mar 2026 - Feb 2027
OPSWAT ICIP	OPSWAT	Mar 2026 - Mar 2027
ISC2 Candidate (CC)	ISC2	Aug 2025 - Aug 2026
Ontario Security Guard Licence	Ontario Government	#50059604 - Active
Smart Serve Ontario	-	Exp. Mar 2029 - #240328413205
Cybersecurity Defense Analyst	Cisco	Expected May 2026
CompTIA Security+	CompTIA	In Progress
Google Cybersecurity	Google	Feb 2026
IBM Cybersecurity Tools	IBM	Feb 2026
...
Education
    ...
    Coursework: Security Incident Response, Open Systems Administration, SDN, Wireless Networks, Linux Administration, Azure Cloud, Databases
    University of Toronto - BSc, Computer Networking & Cybersecurity (Information Analysis) (2022 - 2026)
    Concurrent studies in computer systems, networking, and information security
...
<div align="center">
Open to SOC Analyst, Cybersecurity Analyst, Cloud Security, and Network Security roles anywhere in Canada or internationally.
<a href="mailto:taki@tyfsadik.org"> · <a href="https://tyfsadik.org"> · <a href="https://linkedin.com/in/tyfsadik">
</div>
